  ...
  return (
    <div className="max-w-7xl mx-auto px-3 py-4 space-y-3 xs:px-4 xs:space-y-4 sm:px-6 sm:py-6 sm:space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-lg sm:text-2xl font-bold text-white tracking-wider">{t('title', 'Wallet')}</h1>
          <p className="text-xs sm:text-sm text-neutral-400 mt-1">{t('subtitle', 'On-chain assets & balances')}</p>
        </div>
        <button
          className="flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 text-xs sm:text-sm border border-neutral-700 rounded text-neutral-400 hover:bg-neutral-800 hover:text-neutral-300 bg-transparent transition-colors disabled:opacity-50"
        ...
        <div className="p-3 sm:p-4 md:p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="p-3 sm:p-4 bg-cyan-400/20 rounded-xl border border-cyan-400/30">
                <IconWallet className="w-6 h-6 sm:w-8 sm:h-8 text-cyan-400" />
              </div>
              <div>
                <div className="text-[10px] sm:text-xs text-neutral-400 tracking-wider mb-1">{t('mccBalance', 'MCC Balance')}</div>
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 bg-cyan-700 hover:bg-cyan-600 text-white rounded text-xs sm:text-sm transition-colors"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
            <div className="p-3 sm:p-4 bg-neutral-800 rounded border border-neutral-700">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] sm:text-xs text-neutral-400 tracking-wider">{t('currentBalance', 'Current Balance')}</span>
              </div>
              <div className="text-xl sm:text-2xl font-bold text-cyan-400 font-mono">
                {mcdLoading ? <Spinner /> : mask(fmt(mcdAmount, 6))}
              </div>
              <div className="text-[10px] sm:text-xs text-neutral-500 mt-1">MCD</div>
            </div>
            <div className="p-3 sm:p-4 bg-neutral-800 rounded border border-neutral-700">
              <div className="flex items-center gap-2 mb-2">
                <IconTrendingUp className="h-4 w-4 text-neutral-400" />
                <span className="text-[10px] sm:text-xs text-neutral-400 tracking-wider">{t('totalReceived', 'Total Received')}</span>
              </div>
      ...
      {walletList.length > 0 && (
        <div className="bg-neutral-900 border border-neutral-700 rounded-lg transition-colors">
          <div className="p-3 sm:p-4 md:p-6">
            <div className="flex items-center gap-2 text-neutral-400 text-xs sm:text-sm mb-2 sm:mb-3 md:mb-4">
              <IconWallet className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-400" />
