        ...
        <div className="space-y-2 2xs:space-y-3">
          <div className="bg-white/5 border border-white/10 rounded-lg p-2 2xs:p-3 blockchain-sub-card min-w-0">
            ...
            <div className="flex items-center justify-between gap-2 min-w-0">
              <code className="text-[10px] 2xs:text-xs sm:text-sm text-cyan-400 break-all min-w-0 flex-1">{POOL_ADDRESS}</code>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 2xs:gap-2 sm:gap-3">
            <div className="bg-white/5 border border-white/10 rounded-lg p-2 2xs:p-3 blockchain-sub-card min-w-0">
              ...
              <div className="flex items-center justify-between gap-2 min-w-0">
                <code className="text-[10px] 2xs:text-xs text-neutral-400 break-all min-w-0 flex-1">{USDT_VAULT}</code>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-2 2xs:p-3 blockchain-sub-card min-w-0">
              ...
              <div className="flex items-center justify-between gap-2 min-w-0">
                <code className="text-[10px] 2xs:text-xs text-neutral-400 break-all min-w-0 flex-1">{USDC_VAULT}</code>
