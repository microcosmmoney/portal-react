...
export function MicrocosmDashboardOverview({
  ...
  return (
    <div className="max-w-7xl mx-auto font-mono px-2 py-3 space-y-2 2xs:px-3 2xs:py-4 2xs:space-y-3 sm:px-6 sm:py-6 sm:space-y-6" style={rootStyle}>
      {showHeader && (
        <div className="text-center">
          <h1
            className={accentColor ? 'text-base 2xs:text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight' : 'text-base 2xs:text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-cyan-200'}
      ...
      <LazySection fallback={
        <div className="grid lg:grid-cols-2 gap-2 2xs:gap-3 sm:gap-6"><CardSkeleton height="h-56" /><CardSkeleton height="h-56" /></div>
      }>
        <div className="grid lg:grid-cols-2 gap-2 2xs:gap-3 sm:gap-6">
      ...
      <LazySection fallback={
        <div className="grid lg:grid-cols-2 gap-2 2xs:gap-3 sm:gap-6"><CardSkeleton /><CardSkeleton /></div>
      }>
        <div className="grid lg:grid-cols-2 gap-2 2xs:gap-3 sm:gap-6">
