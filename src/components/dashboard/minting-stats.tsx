      ...
      <div className="p-2 2xs:p-3 sm:p-6">
        {loading ? (
          ...
          <div className="space-y-2 2xs:space-y-3 sm:space-y-4">
            <div className="flex items-center gap-1.5 2xs:gap-2 mb-1 sm:mb-2">
              <IconZap stroke="#5EEAD4" />
              <span className="text-[#5EEAD4] text-[9px] 2xs:text-[10px] sm:text-xs font-mono tracking-widest uppercase truncate">{t('mintingStats', 'MINTING_STATS')}</span>
            </div>
            <div className="grid grid-cols-2 gap-1.5 2xs:gap-2 sm:gap-4">
              <div className="bg-white/5 border border-white/10 rounded-lg p-2 2xs:p-2.5 sm:p-3 blockchain-sub-card min-w-0">
                <div className="text-[8px] 2xs:text-[9px] sm:text-[10px] text-[#5EEAD4] font-mono tracking-widest uppercase mb-1 truncate">{t('totalMinted', 'total_minted')}</div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-2 2xs:p-2.5 sm:p-3 blockchain-sub-card min-w-0">
                <div className="text-[8px] 2xs:text-[9px] sm:text-[10px] text-[#5EEAD4] font-mono tracking-widest uppercase mb-1 truncate">{t('miningPrice', 'mining_price')}</div>
                <div className="text-sm 2xs:text-base xs:text-lg sm:text-xl font-bold font-mono text-cyan-400">
