      ...
      <div className="p-3 sm:p-6">
        <div className="space-y-2 sm:space-y-3">
          {activeLocks.map((lock: any) => (
            <div key={lock.lock_id} className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
              <div className="flex justify-between items-start mb-2">
                <div className="min-w-0 flex-1">
                  <div className="text-[#5EEAD4] text-[10px] sm:text-xs font-mono tracking-widest uppercase truncate">{lock.reason}</div>
