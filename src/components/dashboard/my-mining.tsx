  ...
  return (
    <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl blockchain-card h-full">
      <div className="p-2 2xs:p-3 sm:p-6">
        <div className="flex items-center justify-between mb-2 2xs:mb-3 sm:mb-4">
          <div className="flex items-center gap-1.5 2xs:gap-2 min-w-0">
            {pickaxeIcon}
            <span className="text-[#5EEAD4] text-[9px] 2xs:text-[10px] sm:text-xs font-mono tracking-widest uppercase truncate">{t('myMining', 'MY_MINING')}</span>
          </div>
          <Link href={resolvedDetails} className="flex items-center gap-1 text-[10px] 2xs:text-xs text-neutral-500 hover:text-cyan-400 font-mono whitespace-nowrap">
