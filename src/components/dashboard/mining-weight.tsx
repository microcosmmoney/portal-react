            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              <div className="bg-white/5 border border-white/10 rounded-lg p-2 sm:p-3 blockchain-sub-card">
                <div className="flex items-center gap-1 sm:gap-1.5 mb-1">
                  ...
                  <span className="text-[#5EEAD4] text-[9px] sm:text-xs font-mono tracking-widest uppercase">{t('level', 'level')}</span>
                </div>
                <div className={`text-xs sm:text-sm font-bold font-mono truncate ${rank ? (RANK_COLORS[rank] ?? 'text-neutral-500') : 'text-neutral-500'}`}>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-2 sm:p-3 blockchain-sub-card">
                <div className="flex items-center gap-1 sm:gap-1.5 mb-1">
                  ...
                  <span className="text-[#5EEAD4] text-[9px] sm:text-xs font-mono tracking-widest uppercase">{t('techBonus', 'tech_bonus')}</span>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-2 sm:p-3 blockchain-sub-card">
                <div className="flex items-center gap-1 sm:gap-1.5 mb-1">
                  <IconPickaxe stroke="#5EEAD4" />
                  <span className="text-[#5EEAD4] text-[9px] sm:text-xs font-mono tracking-widest uppercase">{t('miningDays', 'mining_days')}</span>
                </div>
                <div className="text-xs sm:text-sm font-bold font-mono text-white">
                  {miningDays}
                </div>
