...
function EditTerritoryDialog({ territory, open, onClose, onSaved }: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" onClick={onClose}>
      ...
      <div className="relative bg-neutral-900 border border-neutral-700 rounded-lg w-full max-w-sm sm:max-w-md lg:max-w-lg p-3 sm:p-4 md:p-6 space-y-3 sm:space-y-4 mx-4" onClick={(e) => e.stopPropagation()}>
        <div>
        ...
        <div className="flex items-start gap-5">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3 flex-wrap">
              <h2 className="text-lg sm:text-xl font-bold text-white">{territory?.unit_name ?? territoryId}</h2>
              {territory?.short_id && (
      ...
      {statsLoading ? (
        ...
        <div className="grid grid-cols-2 xs:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3">
          <div className="bg-neutral-900 border border-neutral-700 rounded-lg hover:border-cyan-400/50 transition-colors p-4">
            ...
            <p className="text-xl sm:text-2xl font-bold text-white font-mono">{fmt(memberCount)}</p>
          ...
          <div className="bg-neutral-900 border border-neutral-700 rounded-lg hover:border-cyan-400/50 transition-colors p-4">
            ...
            <p className="text-xl sm:text-2xl font-bold text-white font-mono">{fmt(Math.round(vaultBalance))}</p>
          ...
          <div className="bg-neutral-900 border border-neutral-700 rounded-lg hover:border-cyan-400/50 transition-colors p-4">
            ...
            <p className="text-xl sm:text-2xl font-bold text-white font-mono">+{stats?.tech_bonus ?? techBonus}%</p>
          ...
          <div className="bg-neutral-900 border border-neutral-700 rounded-lg hover:border-cyan-400/50 transition-colors p-4">
            ...
            <p className="text-xl sm:text-2xl font-bold text-white font-mono">{occupancy}%</p>
...
export function MicrocosmTerritoryPage({ basePath = '', onNavigate }: MicrocosmTerritoryPageProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 py-4 space-y-3 xs:px-4 xs:space-y-4 sm:px-6 sm:py-6 sm:space-y-6">
      {}
      <div>
        <h1 className="text-lg sm:text-2xl font-bold text-white">{t('title', 'Territory Management')}</h1>
        <p className="text-xs sm:text-sm text-neutral-400 mt-1">{t('subtitle', 'Manage territories, view KPI and vault balances')}</p>
      </div>
