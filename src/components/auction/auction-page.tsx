  ...
  return (
    <div className="max-w-7xl mx-auto px-3 py-4 space-y-3 xs:px-4 xs:space-y-4 sm:px-6 sm:py-6 sm:space-y-6 font-mono">
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div>
          <h1 className="text-lg sm:text-2xl font-bold text-white tracking-wider">{t('title', 'Territory Auctions')}</h1>
          <p className="text-xs sm:text-sm text-neutral-400">{t('subtitle', 'Bid for magistrate positions across the Microcosm')}</p>
        </div>
        <button
      ...
      <div className="bg-neutral-900 border border-neutral-700 rounded-lg">
        <div className="p-3 sm:p-4 md:p-6">
          <div className="grid grid-cols-2 xs:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3">
            <div className="bg-neutral-800 rounded p-2.5 sm:p-4">
              <div className="text-[10px] sm:text-xs text-neutral-400 tracking-wider mb-1">{t('ongoing', 'Ongoing')}</div>
              <div className="text-xl sm:text-2xl font-bold text-cyan-400 font-mono">{auctionList.length}</div>
              <div className="text-[10px] sm:text-xs text-neutral-500">{t('auctionsCount', 'auctions')}</div>
            </div>
            <div className="bg-neutral-800 rounded p-2.5 sm:p-4">
              <div className="text-[10px] sm:text-xs text-neutral-400 tracking-wider mb-1">{t('totalBids', 'Total Bids')}</div>
              <div className="text-xl sm:text-2xl font-bold text-white font-mono">{stats.totalBids}</div>
              <div className="text-[10px] sm:text-xs text-neutral-500">{t('bidsCount', 'bids')}</div>
            </div>
            <div className="bg-neutral-800 rounded p-2.5 sm:p-4">
              <div className="text-[10px] sm:text-xs text-neutral-400 tracking-wider mb-1">{t('highestBid', 'Highest Bid')}</div>
              <div className="text-xl sm:text-2xl font-bold text-cyan-400 font-mono">{stats.highestBid > 0 ? stats.highestBid.toLocaleString() : '--'}</div>
              <div className="text-[10px] sm:text-xs text-neutral-500">MCC</div>
            </div>
            <div className="bg-neutral-800 rounded p-2.5 sm:p-4">
              <div className="text-[10px] sm:text-xs text-neutral-400 tracking-wider mb-1">{t('totalLocked', 'Total Locked')}</div>
              <div className="text-xl sm:text-2xl font-bold text-cyan-400 font-mono">{stats.totalVolume > 0 ? stats.totalVolume.toLocaleString() : '--'}</div>
              ...
              {auctionList.map((auction: any) => {
                ...
                return (
                  ...
                  >
                    ...
                    {}
                    <div className="grid grid-cols-2 xs:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3 mb-2 sm:mb-3 md:mb-4">
