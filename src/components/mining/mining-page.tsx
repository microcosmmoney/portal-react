  ...
  if (isLoading) {
    return (
      <div className="max-w-7xl mx-auto px-3 py-4 space-y-3 xs:px-4 xs:space-y-4 sm:px-6 sm:py-6 sm:space-y-6">
        <div>
          <h1 className="text-lg sm:text-2xl font-bold text-white tracking-wider">{t('title', 'Mining')}</h1>
          <p className="text-xs sm:text-sm text-neutral-400 mt-1">{t('subtitle', 'MCC minting via X402 protocol')}</p>
        </div>
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 text-xs sm:text-sm border border-neutral-700 text-neutral-400 hover:bg-neutral-800 hover:text-neutral-300 bg-transparent rounded-md transition-colors"
        >
      ...
      {}
      <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4 md:p-6 blockchain-card">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 sm:gap-4 md:gap-6 mb-3 sm:mb-4 md:mb-6">
          <div className="space-y-2 sm:space-y-3">
            {}
            <div className="flex items-center gap-2 sm:gap-3">
              <span className="text-[10px] sm:text-xs bg-white/20 text-white px-2 py-0.5 rounded font-medium">{t('x402Protocol', 'X402 Protocol')}</span>
              <span className="text-[10px] sm:text-xs bg-cyan-400/20 text-cyan-400 px-2 py-0.5 rounded font-medium">Solana Mainnet</span>
            </div>

            {}
            <div>
              <div className="text-[10px] sm:text-xs text-[#5EEAD4] tracking-widest uppercase mb-1">MINING_PRICE</div>
              <div className="flex items-baseline gap-2">
                <span className="text-2xl sm:text-3xl font-bold text-cyan-400 font-mono">
                  1 MCC = {miningPrice > 0 ? fmt(miningPrice, 4) : '--'} USD
                </span>
                <span className="text-[9px] sm:text-[10px] bg-cyan-400/20 text-cyan-400 px-1.5 py-0.5 rounded">
                  base × 4
                </span>
              </div>
            </div>
            ...
            {}
            <div className="flex items-start gap-2 sm:gap-3 text-[10px] sm:text-xs text-neutral-500">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-3 sm:px-8 sm:py-4 text-sm sm:text-base font-medium bg-cyan-700 hover:bg-cyan-600 text-white rounded-md whitespace-nowrap flex-shrink-0 disabled:opacity-50 transition-colors"
          >
            <IconZap className="w-4 h-4 sm:w-5 sm:h-5" />
        ...
        <div className="border-t border-neutral-700 pt-3 sm:pt-4 mb-3 sm:mb-4">
          <div className="text-[10px] sm:text-xs text-[#5EEAD4] tracking-widest uppercase uppercase mb-2 sm:mb-3">MINING STATISTICS</div>
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 mb-3 sm:mb-4">
          <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
            <div className="flex items-center gap-2 mb-2">
              <IconTrendingUp />
              <span className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase">CURRENT EPOCH</span>
            </div>
            <div className="text-xl sm:text-2xl font-bold text-cyan-400 font-mono">#{currentEpochNum}</div>
            <div className="text-[10px] sm:text-xs text-neutral-500 mt-1">{fmtCompact(epochYield)} MCC / epoch</div>
          </div>

          <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
            <div className="flex items-center gap-2 mb-2">
              <IconCoins />
              <span className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase">HALVING PHASE {displayPhase}</span>
            </div>
            <div className="text-xl sm:text-2xl font-bold text-white font-mono">{halvingRatio}:1</div>
            <div className="text-[10px] sm:text-xs text-neutral-500 mt-1 tabular-nums">{fmtCompact(totalMinted)} / {fmtCompact(nextHalving)} MCC</div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase">mining_rate</span>
            </div>
            <div className="text-xl sm:text-2xl font-bold text-cyan-400 font-mono">{miningRate > 0 ? `${miningRate}:1` : '--'}</div>
            <div className="text-[10px] sm:text-xs text-neutral-500 mt-1">USD to MCC ratio</div>
          </div>

          <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase">MINING VAULT</span>
            </div>
            <div className="text-xl sm:text-2xl font-bold text-white font-mono">{fmtCompact(miningVaultMcc)}</div>
            <div className="text-[10px] sm:text-xs text-neutral-500 mt-1">MCC available to mine</div>
          </div>
        </div>
      </div>
      ...
      <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4 md:p-6 blockchain-card">
        <div className="flex items-center justify-between mb-2 sm:mb-3">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <span className="text-xs sm:text-sm text-neutral-300 tracking-wider font-medium">{t('onChainBalance', 'On-Chain Balance')}</span>
            {walletList.length > 0 && (
              <span className="inline-flex items-center gap-1 text-[10px] sm:text-xs bg-white/20 text-white px-1.5 py-0.5 rounded">
                <IconCheckCircle />
        ...
        <p className="text-neutral-500 text-[10px] sm:text-xs mb-2 sm:mb-3 md:mb-4">
        ...
        {walletsLoading && walletList.length === 0 ? (
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
            <div className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase mb-1 font-mono">total_balance</div>
            <div className="text-xl sm:text-2xl font-bold font-mono text-white">{fmt(mccBalance, 3)} MCC</div>
            {primaryAddress && (
              <div className="text-neutral-500 text-[10px] sm:text-xs mt-1 font-mono">{primaryAddress.slice(0, 8)}...{primaryAddress.slice(-4)}</div>
            )}
          </div>
        ) : (
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4">
              <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
                <div className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase mb-1 font-mono">total_on_chain</div>
                <div className="text-xl sm:text-2xl font-bold font-mono text-white">
                  {fmt(totalBalance)} MCC
                </div>
                <div className="text-neutral-500 text-[10px] sm:text-xs mt-1">{walletList.length} {t('walletsTotal', 'wallets total')}</div>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
                <div className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase mb-1 font-mono">primary_wallet</div>
                <div className="text-xl sm:text-2xl font-bold font-mono text-white">
                  {primaryWallet ? fmt(primaryWallet.mcc_balance ?? 0) : '--'}
                </div>
                <div className="text-neutral-500 text-[10px] sm:text-xs mt-1 truncate font-mono">
      ...
      <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl blockchain-card">
        <div className="p-3 sm:p-4 md:p-6">
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3">
              <IconHistory />
              <span className="text-xs sm:text-sm text-neutral-300 tracking-wider font-medium">{t('mintRecords', 'Mining Records')}</span>
              {recordsTotal > 0 && (
                <span className="text-[10px] sm:text-xs bg-neutral-500/20 text-neutral-300 px-1.5 py-0.5 rounded">
                  {recordsTotal} {t('records', 'records')}
                </span>
              )}
            </div>
            <div className="flex items-center gap-1 text-[10px] sm:text-xs text-neutral-400 group-hover:text-cyan-400 transition-colors">
              {showRecords ? (
          ...
          {showRecords && (
            <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-neutral-700">
              ...
              {recordsLoading ? (
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-xs sm:text-sm">
                    <thead>
                      <tr className="text-neutral-400 text-[10px] sm:text-xs border-b border-neutral-700">
                    ...
                    <tbody>
                      {records.map((r: any, i: number) => (
                        <tr key={r.tx_signature ?? `${recordsPage}-${i}`} className="border-b border-neutral-800 hover:bg-neutral-800/50">
                          <td className="py-3 text-neutral-300 font-mono text-[10px] sm:text-xs">
                          ...
                          <td className="py-3 text-right">
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-[10px] sm:text-xs px-1.5 py-0.5 rounded bg-white/20 text-white hover:bg-cyan-400/30 hover:text-cyan-200 transition-colors"
                            >
              ...
              {recordsTotal > RECORDS_PAGE_SIZE && (
                <div className="flex items-center justify-between mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-neutral-800 text-[10px] sm:text-xs">
      ...
      {s?.pool_mcc_bought != null && (
        <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4 md:p-6 blockchain-card">
          <div className="text-[10px] sm:text-xs text-[#5EEAD4] tracking-widest uppercase uppercase mb-2 sm:mb-3">POOL STATUS</div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
            <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
              <div className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase font-mono">total_market_made</div>
              <div className="text-base sm:text-lg font-bold text-white font-mono">{fmt(s.pool_mcc_bought ?? 0)}</div>
              <div className="text-[10px] sm:text-xs text-neutral-500 mt-1">MCC bought via CPMM</div>
            </div>
            {s?.pool_usdc_balance != null && (
              <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
                <div className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase font-mono">stablecoin_pool</div>
            ...
            {s?.pool_tvl != null && (
              <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
                <div className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase font-mono">tvl</div>
                <div className="text-base sm:text-lg font-bold text-white font-mono">${fmt(s.pool_tvl ?? 0)}</div>
                <div className="text-[10px] sm:text-xs text-neutral-500 mt-1">Total value locked</div>
              </div>
            )}
          </div>
        </div>
      ...
      {stats && (
        <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4 md:p-6 blockchain-card">
          <div className="text-[10px] sm:text-xs text-[#5EEAD4] tracking-widest uppercase uppercase mb-2 sm:mb-3 md:mb-4 font-mono">MY_MINING_STATS</div>
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
            <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
              <div className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase font-mono">total_mined</div>
              <div className="text-base sm:text-lg font-bold text-white font-mono">{fmt(stats.total_mined ?? 0)} MCC</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
              <div className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase font-mono">total_paid</div>
              <div className="text-base sm:text-lg font-bold text-white font-mono">{fmt(stats.total_paid ?? 0)} USDC</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
              <div className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase font-mono">mining_count</div>
              <div className="text-base sm:text-lg font-bold text-white font-mono">{stats.mining_count ?? 0}</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-4 blockchain-sub-card">
              <div className="text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase font-mono">active_days</div>
              <div className="text-base sm:text-lg font-bold text-white font-mono">{stats.active_days_30d ?? 0}</div>
            </div>
          </div>
        </div>
      )}
