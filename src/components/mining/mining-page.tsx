          ...
          <div className="space-y-1.5 2xs:space-y-2 sm:space-y-3 min-w-0">
            ...
            <div>
              ...
              <div className="flex flex-col 2xs:flex-row items-start 2xs:items-baseline gap-1 2xs:gap-2">
                <span className="text-base 2xs:text-lg xs:text-xl sm:text-2xl md:text-3xl font-bold text-cyan-400 font-mono break-all">
      ...
      <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl p-2 2xs:p-3 sm:p-4 md:p-6 blockchain-card">
        ...
        {walletsLoading && walletList.length === 0 ? (
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-2 2xs:p-2.5 sm:p-4 blockchain-sub-card">
            ...
            <div className="text-lg 2xs:text-xl xs:text-2xl sm:text-3xl font-bold font-mono text-white break-all">{fmt(mccBalance, 3)} MCC</div>
            {primaryAddress && (
          ...
          <>
            <div className="grid grid-cols-1 2xs:grid-cols-2 gap-1.5 2xs:gap-2 sm:gap-3 mb-2 2xs:mb-3 sm:mb-4">
              <div className="bg-white/5 border border-white/10 rounded-lg p-2 2xs:p-2.5 sm:p-4 blockchain-sub-card min-w-0">
                ...
                <div className="text-lg 2xs:text-xl xs:text-2xl sm:text-3xl font-bold font-mono text-white break-all">
        ...
        <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl p-2 2xs:p-3 sm:p-4 md:p-6 blockchain-card">
          ...
          <div className="grid grid-cols-1 2xs:grid-cols-2 lg:grid-cols-3 gap-1.5 2xs:gap-2 sm:gap-3">
            <div className="bg-white/5 border border-white/10 rounded-lg p-2 2xs:p-2.5 sm:p-4 blockchain-sub-card min-w-0">
              ...
              <div className="text-sm 2xs:text-base sm:text-lg font-bold text-white font-mono break-all">{fmt(s.pool_mcc_bought ?? 0)}</div>
            ...
            {s?.pool_usdc_balance != null && (
              <div className="bg-white/5 border border-white/10 rounded-lg p-2 2xs:p-2.5 sm:p-4 blockchain-sub-card min-w-0">
                ...
                <div className="text-sm 2xs:text-base sm:text-lg font-bold text-white font-mono break-all">
            ...
            {s?.pool_tvl != null && (
              <div className="bg-white/5 border border-white/10 rounded-lg p-2 2xs:p-2.5 sm:p-4 blockchain-sub-card min-w-0">
                ...
                <div className="text-sm 2xs:text-base sm:text-lg font-bold text-white font-mono break-all">${fmt(s.pool_tvl ?? 0)}</div>
        ...
        <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl p-2 2xs:p-3 sm:p-4 md:p-6 blockchain-card">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-1.5 2xs:gap-2 sm:gap-3">
            <div className="bg-white/5 border border-white/10 rounded-lg p-2 2xs:p-2.5 sm:p-4 blockchain-sub-card min-w-0">
              ...
              <div className="text-sm 2xs:text-base sm:text-lg font-bold text-white font-mono break-all">{fmt(stats.total_mined ?? 0)} MCC</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-lg p-2 2xs:p-2.5 sm:p-4 blockchain-sub-card min-w-0">
              <div className="text-[8px] 2xs:text-[9px] sm:text-[10px] text-[#5EEAD4] tracking-widest uppercase font-mono truncate">total_paid</div>
              <div className="text-sm 2xs:text-base sm:text-lg font-bold text-white font-mono break-all">{fmt(stats.total_paid ?? 0)} USDC</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-lg p-2 2xs:p-2.5 sm:p-4 blockchain-sub-card min-w-0">
