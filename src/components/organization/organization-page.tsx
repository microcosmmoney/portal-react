  ...
  if (loading) {
    return (
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-wider">Organization</h1>
          <p className="text-sm text-neutral-400 mt-1">Ecosystem structure & territory management</p>
        </div>
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <div className="bg-neutral-900 border border-neutral-700 rounded-lg p-6 hover:border-cyan-400/50 transition-colors">
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <div className="text-sm font-bold text-cyan-400 tracking-wide">User Statistics</div>
            <div className="text-[10px] text-neutral-500 font-mono tracking-wider">User Statistics</div>
          </div>
        </div>
      ...
      {/* ── Territory Distribution + Vault Balance (2-column flip cards) ── */}
      ...
      {/* ── Territory Architecture Card (static hierarchy) ── */}
      <div className="bg-neutral-900 border border-neutral-700 rounded-lg p-6 hover:border-cyan-400/50 transition-colors">
