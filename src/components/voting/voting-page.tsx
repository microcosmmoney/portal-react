    ...
    <div className="max-w-7xl mx-auto px-3 py-4 space-y-3 xs:px-4 xs:space-y-4 sm:px-6 sm:py-6 sm:space-y-6">
      ...
      <div>
        <div className="flex items-center gap-3">
          <h1 className="text-lg sm:text-2xl font-bold text-white tracking-wider">{t('title', 'Community Voting')}</h1>
        ...
        <p className="text-xs sm:text-sm text-neutral-400">{t('subtitle', 'Token-driven community governance and decision-making mechanism')}</p>
      </div>
