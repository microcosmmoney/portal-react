  ...
  return (
    <div className="max-w-7xl mx-auto px-3 py-4 space-y-3 xs:px-4 xs:space-y-4 sm:px-6 sm:py-6 sm:space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div>
          <h1 className="text-lg sm:text-2xl font-bold text-white tracking-wider">{t('title', 'MCD Credits')}</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
          <div>
            ...
            {mcdLoading ? (
              ...
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold font-mono text-cyan-400">
                {fmt(mcdAmount)}
              </div>
            )}
          ...
          <div>
            <div className="text-neutral-400 text-[10px] sm:text-xs font-mono tracking-wider mb-1">total_received</div>
            <div className="text-xl sm:text-2xl font-bold font-mono text-white">{fmt(mcdReceived, 0)}</div>
            <div className="text-[10px] sm:text-xs text-neutral-500 mt-1">lifetime income</div>
          </div>
          <div>
            <div className="text-neutral-400 text-[10px] sm:text-xs font-mono tracking-wider mb-1">total_spent</div>
            <div className="text-xl sm:text-2xl font-bold font-mono text-neutral-400">{fmt(mcdSpent, 0)}</div>
      ...
      <div className="bg-neutral-900 border border-neutral-700 rounded-lg p-6 hover:border-cyan-400/50 transition-colors">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-neutral-400 tracking-wider">{t('onChainBalance', 'On-chain MCD Balance')}</span>
          </div>
          {walletList.length > 1 && (
            <button
