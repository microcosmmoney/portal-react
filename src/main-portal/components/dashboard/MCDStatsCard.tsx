...
import { Banknote, Building2, Users, Clock, Loader2 } from 'lucide-react'
import { Card, CardContent } from '../ui/card'

export default function MCDStatsCard() {
    ...
    <Card className="bg-neutral-900 border-neutral-700 h-full hover:border-cyan-400/50 dash-card">
      <CardContent className="p-3 sm:p-6">
        <div className="flex items-center gap-2 mb-3 sm:mb-4">
          ...
          <span className="text-neutral-400 text-[10px] sm:text-xs font-mono tracking-wider">MCD_STATS</span>
        </div>
